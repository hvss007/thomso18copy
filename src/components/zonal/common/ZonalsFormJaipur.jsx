            ...
            <div id="thomso-zonals-registration-form-lucknow" className="zonalsForm-main-div">
                <div className="zonalsform-main-child">
                    ...
                    <div className="register-zonals-form-div">
                        ...
                        <JaipurEvents onRef={ref => (this.jaipurEvents = ref)} errors={this.state.errors}  selectedevents={this.selected} function={this.changeState} var={this.state.variable} hiding={this.state.isHidden} />
                    </div>
                </div>
            </div>
        );
