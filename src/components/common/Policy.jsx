   ...
   render(){
       return(
           <div>
               ...
               <p>  Effective date: July 29, 2018                  
                </p>
                <p>Thomso.in ("us", "we", or "our") operates the https://thomso.in website (the "Service").</p>
            ...
            <p>Examples of Cookies we use:</p>
             <ul>
              ...
              <h2>Use of Data</h2>
              <p>Thomso.in uses the collected data for various purposes:</p>
              <ul>
                ...
                <p>Thomso.in will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.
                    </p>
             <h2>Disclosure Of Data</h2>  
             <h3>Legal Requirements</h3>
             <p>Thomso.in may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
             <ul>
                 <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of Thomso.in</li>
           ...
           <ul><li>By visiting this page on our website: https://thomso.in</li></ul>
           </div>
       )
