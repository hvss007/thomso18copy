...
var User = require("../../../models/super/Super_Admin");
var Super_Admin_Token = require("../../../models/super/Super_Admin_Token");
                        ...
                        User.updateOne({ username: req.body.username },
                            {
                                ...
                                if (err) {
                                    ...
                                    Super_Admin_Token.find({ username: req.body.username }).sort({ 'updated_date': 1 }).exec(function (err, tokens) {
                                        if (err) {
                                            ...
                                            if (tokens.length > 2 && tokens[0]) {
                                                Super_Admin_Token.update({ _id: tokens[0]._id }, newToken)
                                                    .exec(function (err) {
                                                        if (err) {
                                                ...
                                                var addToken = new Super_Admin_Token(newToken);
