...
var User = require("../../../../models/main/admin/Participants_Admin");
var Participants_Admin_Token = require("../../../../models/main/admin/Participants_Admin_Token");
                    ...
                    User.updateOne({username: req.body.username},
                        {
                            ...
                            if(err){
                                ...
                                Participants_Admin_Token.find({ username: req.body.username }).sort({'updated_date': 1}).exec(function(err, tokens) {
                                    if (err) {
                                        ...
                                        if (tokens.length > 2 && tokens[0]) {
                                            Participants_Admin_Token.update({ _id: tokens[0]._id }, newToken)
                                                .exec(function(err) {
                                                    if (err) {
                                            ...
                                            var addToken = new Participants_Admin_Token(newToken);
